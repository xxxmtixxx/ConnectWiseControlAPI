...
@{
    ...
    FunctionsToExport = @('Get-CWCAuditInfo','Get-CWCAuditLog','Connect-CWC','Get-CWCLauncURL','Add-CWCUserRequiredRole','Add-CWCRemoteWorkforceRequiredRole','New-CWCRemoteWorkforceAssignment','New-CWCMFA','Get-CWCLastContact','Get-CWCSession','Get-CWCSessionDetail','Get-CWCSessionDetails','Invoke-CWCCommand','Invoke-CWCWake','New-CWCAccessToken','Remove-CWCSession','Update-CWCCustomProperty','Update-CWCSessionName','Get-CWCSecurityConfigurationInfo','New-CWCUser','Remove-CWCUser','Update-CWCUser','Get-CWCUser','Get-CWCSessionGroup','New-CWCSessionGroup','Test-CWCreq')
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            Tags         = @('ChrisTaylorCodes', 'ConnectWise', 'Control', 'ScreenConnect', 'API')
            ...
            IconUri      = 'https://raw.githubusercontent.com/christaylorcodes/ConnectWiseControlAPI/master/Media/control-logo.webp'
